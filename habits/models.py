...
class Habit(models.Model):
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.DO_NOTHING, verbose_name='Автор', **NULLABLE)
    ...
    lead_time_new = models.IntegerField(verbose_name='Время на  выполнение привычки в секундах',
                                        validators=[MaxValueValidator(120)], default='1')  # не больше 120секунд!
    ...
    def __str__(self):
        ...
        return f'{self.id}, {self.author}, {self.habit}, {self.habit_time}, {self.place}, {self.is_nice}'
